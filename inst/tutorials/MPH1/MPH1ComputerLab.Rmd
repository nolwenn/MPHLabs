...
Let's focus on the relation between sleep apnea (continuous) and bmi.
...
Here, even though we **controlled for** or **adjusted for** *age* and *gender*, *bmi* is still associated with *SleepApnea_log*. The *bmi* coefficient is, however, slightly different (bigger) from the one obtained in *Part E* - question e (0.034 vs. 0.029).
