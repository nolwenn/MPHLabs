...
Let's focus on the relation between sleep apnea (continuous) and bmi. Age and gender are potential *confounders* with regards to the latter relation (based on the literature - cf the *Introduction* section about sleep apnea).
...
```{r MultiLinRegExample-assumption}
