...
```{r quiz, echo=FALSE}
quiz(question("What statistical tests could be of relevance? (select the two correct options)",
...
```{r quiz2, echo=FALSE}
quiz(question("For this test, what is the H0 hypothesis? (select the correct answer)",
...
library(rstatix)
dunn_test(formula = SleepApnea ~ Triglyceride_Cl_Ref_bis, data = sleepapnea_clean)
...
#For 1 unit increase in bmi, there is 0.029 increase in log(sleepapnea)
...
#There is no association between age and log(sleepapnea)
...
#Interpret the results
#For 1 unit increase in cardiac frequency, there is 0.009 increase in log(sleepapnea)
