...
There are a lot of R functions. Each function has a help page describing this function, its arguments and provides some examples. The *help()* function and *?* help operator in R provide access to the documentation pages for R functions, data sets, and other objects.
